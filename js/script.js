...
function wrapperBuilder(){
	...
	con.appendChild( buttonBuilder("clear","button-style2"))
...
function objChange(){
	...
	if("telefon" in objToChange){objToChange.telefon = parseInt(objToChange.telefon);	}
	return objToChange;
}
...
window.addEventListener("load",() => {  homePageBuilder()  })
